        ...
        <div className="splash__text--container">
          ...
          <div className="splash__nav--container">
            <ul className="splash__nav--ul">
              <li className="splash__nav--item"><a href="#experiences">Experience</a></li>
              <li className="splash__nav--item"><a href="#photos">Photography</a></li>
              <li className="splash__nav--item"><a href="#contacts">Contacts</a></li>
            </ul>
          </div>
        </div>
      </div>
